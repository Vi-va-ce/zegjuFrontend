...
function Box2({TofelData}) {
    return (
        <div>
          ...
          <div className="md:ml-[86px] ml-[33px] md:mt-[-165px] mt-[-58px] absolute">
            <div className=" text-center text-black text-[12.76px] md:text-[28.07px] font-bold font-['Arial'] ">Tofel</div>
          </div>
          ...
          <p className='mt-[-3.5px] md:mt-[-3px] text-[3.76px] md:text-[28.07px] text-white font-bold md:font--semibold'>coming soon</p>
