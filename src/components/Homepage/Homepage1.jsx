    ...
    <div className='  '>
      ...
      <div className='relative flex '>
        ...
        <div className="absolute w-[9.86px] h-[9.86px]  md:w-[41.12px] md:h-[41.12px]  origin-top-left rotate-[-12.93deg] border border-green-500 ml-[54px] md:ml-[140px] mt-[-5px] md:mt-[-40px]" />
          <span className="text-cyan-300 text-lg md:text-5xl font-semibold font-inter">Enhance</span>
          <span className="text-white text-lg md:text-5xl  font-semibold font-inter">. Your. <br/></span>
          <span className="text-cyan-300 text-lg md:text-5xl  font-semibold font-inter">Intellect.</span>
        </div>
        
        <div className="absolute w-[179.36px] md:w-full  text-white text-[6.71px] md:text-[22px]  font-normal font-['Arial'] mt-[96px] md:mt-[200px] ml-[56px] flex-shrink-0">Allow us to guide you on an easy and relaxing learning <br/> experience. Discover your areas of weakness and practice <br/>on them with our personalized timetable to improve your <br/> SAT knowledge with Zegju's assistance.</div>
