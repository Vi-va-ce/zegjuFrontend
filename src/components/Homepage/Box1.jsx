...
function Box1({ SatData }) {
  return (
    <div>
      ...
      <button className="bg-green-700 hover:bg-green-900 w-[38px] md:w-[120px] h-[16px] md:h-[55px] rounded rounded-xl absolute mt-[-33px] md:mt-[-120px] ml-[26px] md:ml-[53px]">
       
          <p className='mt-[-3.5px] md:mt-[-3px] text-[3.76px] md:text-[28.07px] text-white font-bold md:font--semibold'>{SatData}</p>
