...
const Dashboardbar2 = ({questionData}) => {
    ...
    const barWidth = `${((questionData?.right_answer*(containerWidth-2))/100)-2}px`;
    const barWidthTwo = `${((questionData?.right_answer*( containerWidthtwo)) / 100) - 2}px`;
      ...
      <div className=" ">
        <div className="md:w-[420px] w-[159px] md:h-[140px] h-[53px] bg-white md:rounded-[20px] rounded-md ">
          ...
          <div className="absolute md:w-[70px] md:h-8 w-[39.57px] h-[12.17px]  bg-white md:rounded-[20px] rounded-xl md:ml-44 md:mt-24 ml-14 mt-8"><div class="text-slate-900 md:text-[23px] text-[10px] font-normal font-['Inter'] md:ml-6 md:mb-32 ml-4">{questionData?.score}</div></div>
            ...
            <div style={{ width: isMobile ? barWidthTwo : barWidth }}  className={` md:h-[140px] h-[53px] bg-orange-400 hover:bg-orange-800 md:rounded-[18px] rounded-md `}>
            <img src={archaeological} alt="chemical"  className="absolute md:w-[80px] md:h-[80px] w-[35px] h-[35px] md:ml-8 ml-2 md:mt-12 mt-4" />
            <img src={dinosaur} alt="scientist" className="absolute md:w-[80px] md:h-[80px] w-[45px] h-[45px] md:ml-96 ml-32 md:mt-12 mt-2 " />
