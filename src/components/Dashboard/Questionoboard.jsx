...
function Questionoboard({ questionData }) {
  return (
   <div className='flex'>
    <div className='md:ml-52 ml-2 md:p-4 '>
        <div className="static w-[77.61px] h-[110.31px] md:w-[200px] md:h-[280px] bg-white md:rounded-[20px] rounded-md mt-4" >
            ...
            <div className="absolute text-white md:text-2xl text-[10px]  font-semibold font-['Inter'] md:ml-6 md:mt-4 ml-1.5 mt-1">Command of<br/>evidence</div>
           ...
           <div className="text-black md:text-2xl text-[10px] font-normal font-['Inter'] flex md:pt-28 md:pl-6 pt-11 pl-2">
            ...
            <p className="text-black md:text-5xl text-[17px] font-bold font-['Inter']"> {questionData?.first_section?.command_of_evidence?.out_of}</p>
           </div>
            <div className='flex'>
     ...
     <div style={{ marginRight:6 }} className=' md:p-4 pl-2 '>
        <div className="static w-[77.61px] h-[110.31px] md:w-[200px] md:h-[280px] bg-white md:rounded-[20px] rounded-md mt-4" >
            ...
            <div className="absolute text-white md:text-2xl text-[10px]  font-semibold font-['Inter'] md:ml-6 md:mt-4 ml-1.5 mt-1">Expression of<br/>Ideas</div>
         </div>
         <div className="text-black md:text-2xl text-[10px] font-normal font-['Inter'] flex md:pt-28 md:pl-6 pt-11 pl-2">
            <p className='md:pr-3 md:pt-2 pr-1  pt-1'>Questions</p>
            <p className="text-black md:text-5xl text-[17px] font-bold font-['Inter']">{questionData?.first_section?.words_in_context?.out_of}</p>
           </div>
           <div className='flex'>
    ...
    <div style={{ marginRight:6 }} className=' md:p-4 pl-2 '>
        <div className="static w-[77.61px] h-[110.31px] md:w-[200px] md:h-[280px] bg-white md:rounded-[20px] rounded-md mt-4" >
            ...
            <div className="absolute text-white md:text-2xl text-[10px]  font-semibold font-['Inter'] md:ml-6 md:mt-4 ml-1.5 mt-1">Words in<br/>context</div>
         </div>
         <div className="text-black md:text-2xl text-[10px] font-normal font-['Inter'] flex md:pt-28 md:pl-6 pt-11 pl-2">
            <p className='md:pr-3 md:pt-2 pr-1  pt-1'>Questions</p>
            <p className="text-black md:text-5xl text-[17px] font-bold font-['Inter']">{questionData?.first_section?.expression_of_Ideas?.out_of}</p>
           </div>
           <div className='flex'>
    ...
    <div style={{ marginRight:6 }} className=' md:p-4 pl-2 '>
        <div className="static w-[77.61px] h-[110.31px] md:w-[200px] md:h-[280px] bg-white md:rounded-[20px] rounded-md mt-4" >
            ...
            <div className="absolute text-white md:text-2xl text-[10px]  font-semibold font-['Inter'] md:ml-6 md:mt-4 ml-4 mt-3">Total</div>
         </div>
         <div className="text-black md:text-2xl text-[10px] font-normal font-['Inter'] flex md:pt-28 md:pl-6 pt-11 pl-2">
            <p className='md:pr-3 md:pt-2 pr-1  pt-1'>Questions</p>
            <p className="text-black md:text-5xl text-[17px] font-bold font-['Inter']">{questionData?.first_section?.total?.out_of}</p>
           </div>
           <div className='flex'>
                <div className="text-cyan-400 md:text-[32px] text-[14px] font-medium font-['Inter"><p className=' md:pl-8 md:pt-2 pl-2 '>+ {questionData?.first_section?.total?.right_answer} </p></div>
                <div class="text-red-600  md:text-[32px] text-[14px]  font-medium font-['Inter']"><p className='md:pl-12 md:pt-2 pl-3'>- {questionData?.first_section?.total?.wrong_answer}</p></div>
            </div>
            <div className='flex'>
            <div className='md:ml-3 ml-2'><MiniBarBlue data={questionData?.second_section?.total?.right_answer}/></div>
                <div className='md:ml-3 ml-2'><MiniBarRed data={questionData?.second_section?.total?.wrong_answer}/></div>
