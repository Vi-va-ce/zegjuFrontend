...
const MiniBarRed = ({ data }) => {
  ...
  const barWidthTwo = `${((data * containerWidthTwo) / 100) - 2}px`;
    ...
    <div className="flex">
      <div className=" md:w-[80px] w-[29px]  md:h-[10.3px] md:h-4 h-[4.87px] bg-zinc-300 md:rounded-[18px] rounded-[50px]">
        ...
        <div className=' '>
          ...
          <div style={{ width: isMobile ? barWidthTwo : barWidth }} className={`animate-pulse md:h-[8.3px] md:h-3 h-[4.87px] bg-red-600  md:rounded-[18px] rounded-[50px] `}></div>
