  ...
  return (
   ...
   <div className='md:ml-52 ml-2 md:p-4 '>
        <div className="static w-[77.61px] h-[110.31px] md:w-[200px] md:h-[280px] bg-white md:rounded-[20px] rounded-md mt-4" >
            ...
            <div className="absolute text-white md:text-2xl text-[10px]  font-semibold font-['Inter'] md:ml-12 md:mt-8 ml-1.5 mt-1">Algebra</div>
    ...
    <div style={{ marginRight:6 }} className=' md:p-4 pl-2 '>
        <div className="static w-[77.61px] h-[110.31px] md:w-[200px] md:h-[280px] bg-white md:rounded-[20px] rounded-md mt-4" >
            ...
            <div className="absolute text-white md:text-2xl text-[8px]  font-semibold font-['Inter'] md:ml-12 md:mt-4 ml-1.5 mt-1">problem solving</div>
         </div>
         <div className="text-black md:text-2xl text-[10px] font-normal font-['Inter'] flex md:pt-28 md:pl-6 pt-11 pl-2">
            <p className='md:pr-3 md:pt-2 pr-1  pt-1'>Questions</p>
    ...
    <div style={{ marginRight:6 }} className=' md:p-4 pl-2 '>
        <div className="static w-[77.61px] h-[110.31px] md:w-[200px] md:h-[280px] bg-white md:rounded-[20px] rounded-md mt-4" >
            ...
            <div className="absolute text-white md:text-2xl text-[8px]  font-semibold font-['Inter'] md:ml-12 md:mt-4 ml-1.5 mt-1">passport advanced</div>
         </div>
         <div className="text-black md:text-2xl text-[10px] font-normal font-['Inter'] flex md:pt-28 md:pl-6 pt-11 pl-2">
            <p className='md:pr-3 md:pt-2 pr-1  pt-1'>Questions</p>
