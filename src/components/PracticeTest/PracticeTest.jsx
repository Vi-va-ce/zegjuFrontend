...
const TestBodyTwo = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://937a35d9-4e84-4399-a0b9-e45b0208a631.mock.pstmn.io/api/v2/student/evidencebased');
          ...
          {testData && (
            <>
              <div className='scrollable-content md:max-h-[380px] max-h-[510px]'>
                ...
                <ChoicesTwo data={testData} currentIndex={currentIndex} />
              </div>
