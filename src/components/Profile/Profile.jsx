...
function Profile({standardfirstName,satEnglish,satMath,average,picture}) {
...
<TestNav/>
    ...
    <div className="left-[60.92px] top-[389.15px]  md:ml-[390px] md:mt-[-100px] absolute text-gray-900 text-xs   font-normal font-['Inter']">First name</div>
    <div className="left-[60.92px] top-[511.35px]  md:ml-[390px] md:mt-[-100px] absolute text-gray-900 text-xs font-normal font-['Inter']">Email</div>
    <div className="left-[60.92px] top-[572.45px]  md:ml-[390px] md:mt-[-100px] absolute text-gray-900 text-xs font-normal font-['Inter']">Phone number</div>
    <div className="left-[60.92px] top-[450.25px]  md:ml-[390px] md:mt-[-100px] absolute text-gray-900 text-xs font-normal font-['Inter']">Last name</div>
    ...
    <div className="w-[198.82px] h-[29.01px] left-[60.92px]  md:ml-[390px] md:mt-[-100px] top-[534.80px] absolute">
     ...
     <div className="w-[199.21px] h-[29.01px] left-[60.92px]  md:ml-[390px] md:mt-[-100px] top-[595.90px] absolute">
    <input type="tel" id="phoneNumber" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} required className="absolute text-black text-xs font-normal font-['Inter'] w-[198.82px] h-[29.01px] md:w-[322px] md:h-[30px]  md:rounded-[24.93px] left-0 top-0 absolute bg-zinc-300 bg-opacity-0 rounded-2xl border border-cyan-300 "/>
     </div>
     <Link to="/changepassword">
          <div className="left-[136.83px] top-[636.02px] md:ml-[590px] md:mt-[-102px] absolute text-indigo-500 text-xs font-normal font-['Inter'] md:text-[18px]">
            Change password
          </div>
        </Link>
     <button className="w-[204.77px] h-[39.50px] left-[77.20px]  md:ml-[390px] md:mt-[-120px] top-[691.05px] absolute bg-yellow-500  md:ml-[500px] rounded-[10.39px] hover:bg-yellow-700">
        <div className="left-[143.79px] top-[13.17px]  absolute text-white text-[11.09px] font-normal font-['Inter']">ETB 2500</div>
        <div className="left-[26.33px] top-[13.17px]   absolute text-white text-[11.09px] font-normal font-['Inter']">Upgrade to premium</div>
      </button>
